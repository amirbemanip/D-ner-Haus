      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-12 border-b border-white/5 pb-12">
          <div className="space-y-4">
            ...
            <h1 className="text-6xl font-display font-bold text-white uppercase tracking-tighter">Club <span className="text-outline">Insights</span></h1>
          </div>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-white/5">
                    <th className="px-10 py-6 text-[9px] font-bold uppercase tracking-[0.4em] text-gray-500">Profile</th>
                    <th className="px-10 py-6 text-[9px] font-bold uppercase tracking-[0.4em] text-gray-500">Security Code</th>
                    <th className="px-10 py-6 text-[9px] font-bold uppercase tracking-[0.4em] text-gray-500 text-center">Loyalty Status</th>
                    <th className="px-10 py-6 text-[9px] font-bold uppercase tracking-[0.4em] text-gray-500">Gift Status</th>
                    <th className="px-10 py-6 text-[9px] font-bold uppercase tracking-[0.4em] text-gray-500">Registered</th>
                  </tr>
                </thead>
                      ...
                      >
                        <td className="px-10 py-6">
                          <div className="flex flex-col">
                            <span className="font-bold text-white text-lg group-hover:text-gold transition-colors">{c.name}</span>
                        ...
                        <td className="px-10 py-6">
                          <div className="flex flex-col items-center gap-2">
                            <span className="font-display font-bold text-xl">{c.coupons}</span>
                        ...
                        <td className="px-10 py-6 text-gray-600 font-mono text-[10px]">
